...
This thesis is organized as follows: in \labelindexref{Chapter}{chapter:second} we describe the main types of malware threats, current detection types, methods that malware uses to avoid detection and a short presentation of the malware specification mining algorithm.

In \labelindexref{Chapter}{chapter:third} we define several notions used in the algorithm, a detailed view of the malspec mining algorithm and we reveal our own architecture. \labelindexref{Chapter}{chapter:fourth} presents the implementation details for each element of the architecture from kernel modules to the userspace application.
